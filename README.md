...
> 当前版本：v1.6.0（src 布局，`pip install` 可装；Python ≥ 3.9）
...
- **欢迎贡献知识库**：14 品类条目持续补充中（服装 30 组最深，部分品类 6-17 组）——补强品类条目、完善场景×光线组合、修正错误都可以直接提 PR（知识库是 JSON + schema 程序化校验，改完跑 `ecommerce-video kbcheck` 35/35 通过即可）
